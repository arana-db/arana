...
const (
	...
	// ComCreateDB is COM_CREATE_DB
	ComCreateDB = 0x05

	// ComDropDB is COM_DROP_DB , drop a schema
	ComDropDB = 0x06
	...
	// ComStatistics is COM_STATISTICS, get a human readable string of internal statistics.
	ComStatistics = 0x09
...
// this is a bitmask of sub-systems to refresh
