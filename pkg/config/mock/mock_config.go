...
func (m *MockCenter) ImportAll(ctx context.Context, cfg *config.Tenant) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ImportAll", ctx, cfg)
	ret0, _ := ret[0].(error)
	return ret0
}

// ImportAll indicates an expected call of ImportAll.
func (mr *MockCenterMockRecorder) ImportAll(ctx, cfg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ImportAll", reflect.TypeOf((*MockCenter)(nil).ImportAll), ctx, cfg)
}
...
// ImportAll mocks base method.
func (m *MockConfigWriter) ImportAll(ctx context.Context, cfg *config.Tenant) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ImportAll", ctx, cfg)
	ret0, _ := ret[0].(error)
	return ret0
...
// ImportAll indicates an expected call of ImportAll.
func (mr *MockConfigWriterMockRecorder) ImportAll(ctx, cfg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ImportAll", reflect.TypeOf((*MockConfigWriter)(nil).ImportAll), ctx, cfg)
}
