...
type (
	...
	ConfigData struct {
		...
		ShardingRules      *[]ShardingRule     `yaml:"shardingRules,omitempty" json:"shardingRules,omitempty"`
	}
	...
	ConnProp struct {
		...
		IdleTimeout time.Duration `yaml:"idleTimeout" json:"idleTimeout,omitempty"` // close backend direct connection after idle_timeout
	}
